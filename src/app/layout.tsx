...
export const metadata: Metadata = {
  title: 'Preetorian Integrated Solutions | Professional Security Services',
  ...
  keywords: 'security services, manned guarding, CCTV monitoring, event security, Preetorian Integrated Solutions, Bhubaneswar security, professional security',
