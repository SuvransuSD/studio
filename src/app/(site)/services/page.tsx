...
const services = [
  {
    ...
    image: imageData.servicesPage.mannedGuarding,
  },
  {
    ...
    image: imageData.servicesPage.cctv,
  },
  {
    ...
    image: imageData.servicesPage.mobilePatrols,
  },
  {
    ...
    image: imageData.servicesPage.alarmResponse,
  },
  {
    ...
    image: imageData.servicesPage.corporateSecurity,
  },
  {
    ...
    image: imageData.servicesPage.eventSecurity,
  },
];
          ...
          <DialogContent className="sm:max-w-2xl p-0 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] duration-500">
            <div className="relative h-64 w-full rounded-t-lg overflow-hidden">
                <Image
                    ...
                    data-ai-hint={selectedService.image.dataAiHint}
                    fill
